...
<form action="{{ route('compras.store') }}" method="POST" class="card--form">
    ...
    <div>
        ...
        <input id="impuestos_internos" type="text" name="impuestos_internos" value="{{ old('impuestos_internos') }}" />
    </div>
    <div>
    ...
    <div>
        ...
        <input id="compras_no_inscriptas" type="text" name="compras_no_inscriptas" value="{{ old('compras_no_inscriptas') }}" />
    </div>
    <br>
    <hr>
    <br>
