...
<div class="container-fluid">
  ...
  <a href="ventas/create" class="d-flex flex-row align-items-center my-2 g-3">
    <div class="btn-icon">
  ...
  <table id="resizeMe" class="table table-striped">
    ...
    <tr>
      ...
      <td class="vertical-middle"> {{$c->ingresos_exentos }} </td>
      <td class="vertical-middle"> {{$c->ganancias_retencion }} </td>
